...
*/
    ...
    function hb(a, b, c, d) {
        ...
        null != f
            ? ("+" === f.charAt(0) && e.g(f),
              (f = b.indexOf("tel:")),
              e.g(
                  b.substring(0 <= f ? f + 4 : 0, b.indexOf(";phone-context="))
              ))
            : ((f = e.g),
              (g = b ?? ""),
              (h = g.search(Ja)),
        ...
        try {
            ...
            if ("Invalid country calling code" == ca.message && L.test(l)) {
                if (
                    ((l = l.replace(L, "")), (h = fb(a, l, g, b, d, f)), 0 == h)
                )
                    throw ca;
            } else throw ca;
        }
    ...
    function pb(a, b) {
        ...
        switch (a.ba.h.length) {
            ...
            default:
                if (a.ea)
                    return (
                        rb(a) && (a.ea = !1), a.h.toString() + a.g.toString()
                    );
                if (0 < a.j.length) {
                    b = vb(a, b);
                    c = wb(a);
    ...
    const yb = (a) => {
            const b = [];
            a.includes("FIXED_LINE_OR_MOBILE")
                ? (a.includes("MOBILE") || b.push("MOBILE"),
                  a.includes("FIXED_LINE") || b.push("FIXED_LINE"))
                : (a.includes("MOBILE") || a.includes("FIXED_LINE")) &&
                  b.push("FIXED_LINE_OR_MOBILE");
            return a.concat(b);
        },
        zb = {
            FIXED_LINE: 0,
